...
func testFcitxToMac() {
  ...
  assert(fcitxStringToMacShortcut("Shift+Super+Shift_L") == ("⌘⇧ᴸ", nil))
  assert(fcitxStringToMacShortcut("Shift+Super+Super_L") == ("⇧⌘ᴸ", nil))
  assert(fcitxStringToMacShortcut("Alt+Shift+Shift_R") == ("⌥⇧ᴿ", nil))
