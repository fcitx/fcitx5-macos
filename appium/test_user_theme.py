...
def test_user_theme(driver: WebDriver, app: str):
    ...
    button = find_element_by_id(driver, "SelectTheme")
    ...
    assert get_label(find_element_by_id(driver, "SelectTheme")) == THEME, UI_NOT_UPDATED
    ...
    assert get_label(find_element_by_id(driver, "SelectTheme")) == prompt_label, (
        UI_NOT_UPDATED
    )
