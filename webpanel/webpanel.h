...
FCITX_CONFIGURATION(
    ...
    Option<KeyList> expand{
        this, "Expand", _("Expand"),
        {Key(FcitxKey_bracketright), Key(FcitxKey_equal), Key(FcitxKey_Down)}};
    Option<KeyList> collapse{
        this, "Collapse", _("Collapse"),
        {Key(FcitxKey_bracketleft), Key(FcitxKey_minus)}};
    Option<KeyList> up{
        this, "Up", _("Up"),
        {Key(FcitxKey_bracketleft), Key(FcitxKey_minus), Key(FcitxKey_Up)}};
    Option<KeyList> down{
        this, "Down", _("Down"),
        {Key(FcitxKey_bracketright), Key(FcitxKey_equal), Key(FcitxKey_Down)}};
